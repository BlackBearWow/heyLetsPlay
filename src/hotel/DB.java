...
public class DB
{
	...
	public static String getHotelOwnerNameByHostId(String id) {
		try {
			...
			System.err.println("\n SQL error in getHotelOwnerNameByHostId(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	...
	public static Vector<Room> selectRooms(String hotelname) {
		try {
			...
			System.err.println("\n SQL error in selectRooms(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	...
	public static String getHotelOwnerNameByHotelName(String hotel_name) {
		try {
			...
			System.err.println("\n SQL error in getHotelOwnerNameByHotelName(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	...
	public static int deleteReservation(String hotel_name, int room_num, String c_id, String start_date_of_use)
	{
		...
		try {
			...
			System.err.println("\n SQL executeUpdate error in deleteReservation(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return cnt;
	}
	...
	public static Room selectRoomByHotelNameAndRoomNum(String hotel_name, int room_num) {
		try {
			...
			System.err.println("\n SQL error in selectRoomByHotelNameAndRoomNum(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	...
	public static Vector<Reservation> selectReservationsByC_id(String c_id) {
		try {
			...
			System.err.println("\n SQL error in selectReservationsByC_id(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	...
	public static Vector<Reservation> selectReservationsByRoom(Room room) {
		try {
			...
			System.err.println("\n SQL error in selectReservationsByRoom(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	
	//업주 name에 해당하는 예약들을 반환하는 메소드 
	public static Vector<Reservation> selectReservationsByHotelOwnerName(String name) {
		try {
			...
			System.err.println("\n SQL error in selectReservationsByHotelOwnerName(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	...
	public static Vector<ReservationCancellation> selectReservationCancellationsByC_id(String c_id) {
		try {
			...
			System.err.println("\n SQL error in selectReservationCancellationsByC_id(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
	
	//업주 name에 해당하는 예약취소들을 반환하는 메소드 
	public static Vector<ReservationCancellation> selectReservationCancellationsByHotelOwnerName(String name) {
		try {
			...
			System.err.println("\n SQL error in selectReservationCancellationsByHotelOwnerName(): " + ex.getMessage() );
			ex.printStackTrace();
		}
		return null;
	}
